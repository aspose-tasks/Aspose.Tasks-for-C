...
void ReducingGapBetweenTasksListAndFooter::Run()
{
    ...
    project->Save(dataDir + u"ReducingGapBetweenTasksListAndFooter_out.png", System::ExplicitCast<Aspose::Tasks::Saving::SaveOptions>(imageSaveOptions));
    ...
    project->Save(dataDir + u"ReducingGapBetweenTasksListAndFooter_out.pdf", System::ExplicitCast<Aspose::Tasks::Saving::SaveOptions>(pdfSaveOptions));
