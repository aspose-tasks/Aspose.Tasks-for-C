...
RTTI_INFO_IMPL_HASH(3687031175u, ::Aspose::Tasks::Examples::CPP::ConvertingProjectData::RenderProjectDataToFormat24bppRgb, ThisTypeBaseTypesInfo);

void RenderProjectDataToFormat24bppRgb::Run()
{
