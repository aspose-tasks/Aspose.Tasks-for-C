...
RTTI_INFO_IMPL_HASH(290983201u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveBurnDownReport, ThisTypeBaseTypesInfo);

void SaveBurnDownReport::Run()
{
