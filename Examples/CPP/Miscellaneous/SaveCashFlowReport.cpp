...
RTTI_INFO_IMPL_HASH(2266090769u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveCashFlowReport, ThisTypeBaseTypesInfo);

void SaveCashFlowReport::Run()
{
