...
RTTI_INFO_IMPL_HASH(1677756416u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveLateTasksReport, ThisTypeBaseTypesInfo);

void SaveLateTasksReport::Run()
{
