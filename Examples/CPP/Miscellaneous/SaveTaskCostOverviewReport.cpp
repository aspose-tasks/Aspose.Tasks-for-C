...
*/
#include "SaveTaskCostOverviewReport.h"
...
RTTI_INFO_IMPL_HASH(749550843u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveTaskCostOverviewReport, ThisTypeBaseTypesInfo);

void SaveTaskCostOverviewReport::Run()
{
