...
*/
#include "SaveCostOverviewReport.h"
...
RTTI_INFO_IMPL_HASH(4242416694u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveCostOverviewReport, ThisTypeBaseTypesInfo);

void SaveCostOverviewReport::Run()
{
