...
*/
#include "SaveUpcomingTasksReport.h"
...
RTTI_INFO_IMPL_HASH(2146706346u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveUpcomingTasksReport, ThisTypeBaseTypesInfo);

void SaveUpcomingTasksReport::Run()
{
