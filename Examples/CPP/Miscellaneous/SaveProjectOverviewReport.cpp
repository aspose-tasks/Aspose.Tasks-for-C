...
*/
#include "SaveProjectOverviewReport.h"
...
RTTI_INFO_IMPL_HASH(1144305962u, ::Aspose::Tasks::Examples::CPP::Miscellaneous::SaveProjectOverviewReport, ThisTypeBaseTypesInfo);

void SaveProjectOverviewReport::Run()
{
