#include "GetTaskBaselineSchedule.h"
...
RTTI_INFO_IMPL_HASH(2321646838u, ::Aspose::Tasks::Examples::CPP::WorkingWithTaskBaselines::GetTaskBaselineSchedule, ThisTypeBaseTypesInfo);

void GetTaskBaselineSchedule::Run()
{
