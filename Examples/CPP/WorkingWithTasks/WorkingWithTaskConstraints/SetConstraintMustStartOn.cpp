...
*/
#include "SetConstraintMustStartOn.h"
...
RTTI_INFO_IMPL_HASH(560407033u, ::Aspose::Tasks::Examples::CPP::WorkingWithTasks::WorkingWithTaskConstraints::SetConstraintMustStartOn, ThisTypeBaseTypesInfo);

void SetConstraintMustStartOn::Run()
{
    // The path to the documents directory.
    System::String dataDir = RunExamples::GetDataDir(System::Reflection::MethodBase::GetCurrentMethod(ASPOSE_CURRENT_FUNCTION)->get_DeclaringType().get_FullName());
    
    // Create project instance
    System::SharedPtr<Project> project1 = System::MakeObject<Project>(dataDir + u"ConstraintMustStartOn.mpp");
