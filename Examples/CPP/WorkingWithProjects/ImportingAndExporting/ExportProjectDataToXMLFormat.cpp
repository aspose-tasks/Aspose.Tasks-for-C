...
RTTI_INFO_IMPL_HASH(1314430262u, ::Aspose::Tasks::Examples::CPP::WorkingWithProjects::ImportingAndExporting::ExportProjectDataToXMLFormat, ThisTypeBaseTypesInfo);

void ExportProjectDataToXMLFormat::Run()
{
