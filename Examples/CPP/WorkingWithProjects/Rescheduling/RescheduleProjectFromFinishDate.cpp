...
RTTI_INFO_IMPL_HASH(1807823185u, ::Aspose::Tasks::Examples::CPP::WorkingWithProjects::Rescheduling::RescheduleProjectFromFinishDate, ThisTypeBaseTypesInfo);

void RescheduleProjectFromFinishDate::Run()
{
